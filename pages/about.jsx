...
const About = () => {
    ...
    return (
        <>
                    ...
                    <div className="row about-container">
                        ...
                        <div className="col-12 col-md-6 col-lg-6">
                            <div className="about-text">
                                <h2 className="main-heading-with-double-color mt-0">
                                    Your Trusted <span className="highlight-text1"> Dental Lab </span> for All Your Clinical Needs
                                </h2>
                                <p>
                        ...
                        <div className="about-content d-flex justify-content-center align-items-center">
                            ...
                            <div className="about-text">
                                <h2 className="main-heading-with-double-color">
                                    Delivering Excellence In <span className="highlight-text1"> Across The USA </span>
                                </h2>
                ...
                <div className="container about-section">
                    <div className="row">
                        <div className="col-12 col-lg-6 about-left">
                            ...
                            <div className="about-text w-40 pl-0">
                                <h2 class="main-heading-with-double-color mt-0">Working Only With <span className="highlight-text1">The Best</span></h2>
                            </div>
                            <Image
                    ...
                    <div className="about-section d-flex align-items-center">
                        <div class="row" style={{ margin: "0px" }}>
                            ...
                            <div class="col-lg-5  col-12 card-wop right-card">
                                <div className="about-text ">
                                    <h2 className="main-heading-with-double-color"> <span className="highlight-text1">Uncompromising Precision </span>and  <span className="highlight-text2">Excellence </span>in Dental Restorations</h2>
                                </div>
            ...
            <section className="standard-work m-4">
                <div className="container ">
                    <div className="row align-items-stretch">
                        <div className="col-lg-6  d-flex flex-column justify-content-center h-90 order-md-0 order-0">
                            <div className="about-text">
                                <h2 className="main-heading-with-double-color">
                                    Committed to the Highest <span className="highlight-text1"> Standards of Excellence</span>
                                </h2>
                                <p>
                        ...
                        <div className="col-lg-6  align-items-stretch order-lg-2 order-3">
                            <Image
